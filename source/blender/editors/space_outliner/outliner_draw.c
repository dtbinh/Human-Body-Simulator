...
static void restrictbutton_recursive_bone(bContext *C, bArmature *arm, ArmatureElement *bone_parent, int flag, bool set_flag)
{
...
static void restrictbutton_bone_visibility_cb(bContext *C, void *poin, void *poin2)
{
	...
	ArmatureElement *bone = (ArmatureElement *)poin2;
			...
			switch (tselem->type) {
				...
				case TSE_EBONE:
				{
					...
					if (arm->edel) {
						...
						ED_armature_element_rename(obedit->data, oldname, newname);
